/**
 * KPSS Akademisi — 2026 ÖSYM Standartlarında Tam Kapsamlı Soru Külliyatı
 * Tarih, Coğrafya, Vatandaşlık, Türkçe, Matematik, Güncel Bilgiler
 */

var KPSS_QUESTION_BANK = [
  // ================= 1. TARİH — İLK TÜRK DEVLETLERİ =================
  {
    id: 1,
  ...
  // ================= 3. TARİH — OSMANLI DEVLET TEŞKİLATI =================
  {
    id: 3,
    ...
    answer: 2,
    keyPoint: "📌 KİLİT BİLGİ: İlmiye sınıfı Türk-Müslüman kökenli ve medrese mezunu olmak zorundadır (Kazasker, Şeyhülislam, Kadı, Müderris). Sadrazam ise Seyfiye (yönetim-askeriye) sınıfının başıdır.",
  ...
  // ================= 10. VATANDAŞLIK — YARGI ORGANLARI =================
  {
    id: 10,
    period: "2024 KPSS Lisans",
    topic: "Vatandaşlık",
  ...
  // ================= 12. TÜRKÇE — CÜMLE ANALİZİ =================
  {
    ...
    answer: 0,
    keyPoint: "📌 KİLİT BİLGİ: 'Taşımak' fiili şimdiki zaman kipi (-yor) almış basit yapılı bir fiildir. Birleşik fiil olabilmesi için iki fiilin/sözcüğün birleşmesi gerekir.",
  ...
  // ================= 15. GÜNCEL BİLGİLER — GÖBEKLİTEPE =================
  {
    id: 15,
    period: "2024 KPSS Lisans",
  ...
  // ================= 16. 2022 KPSS ORTAÖĞRETİM / LİSANS SORULARI =================
  {
    id: 16,
    period: "6 Kasım 2022 KPSS",
    topic: "Türkçe",
    subTopic: "Paragrafta Anlam ve Yorum",
    type: "klasik",
    ...
    answer: 0,
    keyPoint: "📌 KİLİT BİLGİ: ÖSYM 2022 KPSS Türkçe 1. sorusudur. Paragrafta bireyin anı yaşamak yerine başkalarına göstermeye odaklanması eleştirilmektedir.",
    trapWarning: "⚠️ ÖSYM TUZAĞI: 'Beğenilme kaygısı' çeldiricidir; asıl vurgu 'yaşamak yerine görülmeyi tercih etmek'tir.",
    explanation: `Parçada bir mekânda bulunup anı hissetmek (yaşamak) yerine fotoğraf çekip başkalarına sunmak (görülmek) vurgulandığı için A şıkkı doğrudur.`,
    lawRef: "ÖSYM 2022 KPSS Ortaöğretim — Soru #1"
  },
  {
    id: 17,
    period: "6 Kasım 2022 KPSS",
    topic: "Tarih",
    subTopic: "İslamiyet Öncesi Türk Tarihi",
    type: "oncullu",
    question: `İslamiyet öncesi Türk devletlerinde görülen;\n\nI. Kurultay (Toy) toplantılarına Hatun'un da katılması,\nII. Hakanın eşinin elçileri kabul edebilmesi,\nIII. Hükümdarın olmadığı zamanlarda Hatun'un devleti temsil edebilmesi\n\ndurumlarından hangileri Türk kadınının siyasi ve idari alanda hak sahibi olduğunu kanıtlar?`,
    options: [
      "A) Yalnız I",
      "B) I ve II",
      "C) I ve III",
    ...
    answer: 4,
    keyPoint: "📌 KİLİT BİLGİ: İlk Türk devletlerinde Hatun yüksek siyasi yetkilere sahipti. Kurultaya katılır, elçi kabul eder ve hakan sefere çıktığında naip olarak devleti yönetirdi.",
    trapWarning: "⚠️ ÖSYM TUZAĞI: İlk Türk devletlerinde kadının siyasi statüsü diğer eski uygarlıklara göre çok daha ileridir.",
    explanation: `Verilen üç öncül de kadının siyasi ve yönetim yetkilerinin açık kanıtıdır.`,
    lawRef: "ÖSYM 2022 KPSS Tarih — Türk Kültür Medeniyeti"
  },
  {
    id: 18,
    period: "6 Kasım 2022 KPSS",
    topic: "Vatandaşlık",
    subTopic: "1982 Anayasası — Temel Hak ve Hürriyetler",
    type: "klasik",
    question: `1982 Anayasası'na göre aşağıdakilerden hangisi 'Kişinin Hakları ve Ödevleri' (Negatif Statü Hakları / Koruyucu Haklar) arasında yer alır?`,
    options: [
    ...
    answer: 0,
    keyPoint: "📌 KİLİT BİLGİ: Konut Dokunulmazlığı = Kişi Hakları (Negatif Statü). Çalışma ve Sendika = Sosyal-Ekonomik Haklar (Pozitif Statü). Seçme-Seçilme ve Vergi = Siyasi Haklar (Aktif Statü).",
    trapWarning: "⚠️ ÖSYM TUZAĞI: Jellinek haklar tasnifi (Negatif, Pozitif, Aktif) her yıl KPSS Vatandaşlıkta mutlaka sorulur!",
    explanation: `Konut dokunulmazlığı devletin müdahale edemeyeceği koruyucu / negatif statü haklarındandır.`,
    lawRef: "1982 T.C. Anayasası — Madde 21"
  },
  {
    id: 19,
    period: "22 Kasım 2020 KPSS",
    topic: "Türkçe",
    subTopic: "Cümlede Anlam ve Boşluk Doldurma",
    type: "klasik",
    ...
    options: [
      ...
      "C) yoğunlaşarak - uyum",
      "D) kapılarak - mekân",
      "E) değinerek - maddiyat"
    ],
    answer: 1,
    keyPoint: "📌 KİLİT BİLGİ: ÖSYM 2020 KPSS 1. Soru. Cümle akışında 'tarihin akışına bakarak' ve 'mutluluğa imkân sağladığı hâlde' mantıksal uyumu tamamlar.",
    trapWarning: "⚠️ ÖSYM TUZAĞI: İkinci boşluktaki 'sağladığı hâlde' ifadesi öncesinde olumlu bir olanak (imkân) gerektirir.",
    explanation: `Cümle bağlamında 'bakarak' ve 'imkân' kelimeleri tam anlam bütünlüğü sağlar.`,
    lawRef: "ÖSYM 2020 KPSS Ortaöğretim — Soru #1"
  },
  {
    id: 20,
    period: "22 Kasım 2020 KPSS",
    topic: "Tarih",
    subTopic: "Selçuklu ve Türk-İslam Tarihi",
    type: "oncullu",
    question: `Büyük Selçuklu Devleti'nde uygulanan İkta Sistemi ile ilgili olarak;\n\nI. Toprağın mülkiyetinin devlete ait olması,\nII. Üretimde sürekliliğin sağlanması,\nIII. İkta sahiplerinin devlete atlı asker (Cebelü) yetiştirmesi\n\nhususlarından hangileri devletin hazineden para harcamadan güçlü bir ordu kurmasını sağlamıştır?`,
    options: [
      "A) Yalnız I",
      "B) Yalnız III",
      "C) I ve II",
    ...
    answer: 1,
    keyPoint: "📌 KİLİT BİLGİ: İkta sisteminde vergi gelirleriyle beslenen ve yetiştirilen atlı askerlere 'Cebelü' denir. Bu sayede devlet hazinesine yük olmadan savaşa hazır devasa bir ordu elde edilir.",
    trapWarning: "⚠️ ÖSYM TUZAĞI: Soru 'hazineye yük olmadan ordu kurma'yı sormaktadır, bu doğrudan Cebelü askerleriyle ilgilidir.",
    explanation: `Yalnızca III. öncül hazineden para çıkmadan ordu beslenmesini doğrudan açıklar.`,
    lawRef: "ÖSYM KPSS Tarih — Türk-İslam Devletlerinde İkta Sistemi"
  }
];
